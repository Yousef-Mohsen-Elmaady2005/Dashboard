...
const AddManager = () => {
  ...
  return (
    <section className="max-w-2xl">
      ...
      <form noValidate onSubmit={submit} className="space-y-5 rounded-xl bg-white p-5 shadow">
        {errors.length > 0 && (
        ...
        <div className="flex gap-3">
          <button className="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-indigo-700">Add Manager</button>
