...
const TopBar = () => {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 h-[70px] border-y border-[#d7d7d7] bg-white shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
      <div className="flex h-full items-center gap-7 px-6 text-[#14213d]" dir="ltr">
        <button
          type="button"
        ...
        <button type="button" className="inline-flex items-center gap-2 text-lg hover:text-indigo-600" aria-label="Change language">
          <span>EN</span>
          <FontAwesomeIcon icon={faLanguage} className="text-base" />
        </button>

        <div className="inline-flex items-center gap-1.5 text-base" dir="rtl">
